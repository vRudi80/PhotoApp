...
export default function MapSpotsView({ user, setFullscreenData, targetMapSpotId, setTargetMapSpotId }: MapSpotsViewProps) {
  ...
  // Térkép példány referenciájának tárolása a biztonságos zoom/pan kezeléshez
  ...
  // Fő helyszín feltöltés állapota
  ...
  // Megerősítés kérése áthúzáskor + Mégse esetén pozíció biztonságos visszaállítása
    ...
    if (e.target.files && e.target.files.length > 0) {
      ...
      try {
        ...
        if (exifData) {
          ...
          // 3. Dátum elemzése (Hónap és Napszak becslése az órából)
