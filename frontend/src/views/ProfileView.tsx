      ...
      <div style={{ width: '100%', maxWidth: '600px', background: '#1e293b', padding: '40px', borderRadius: '24px', border: '1px solid #10b981', boxShadow: '0 10px 30px rgba(16, 185, 129, 0.15)' }}>
        <div style={{ textAlign: 'center', marginBottom: '25px' }}>
          ...
          <p style={{ color: '#94a3b8', fontSize: '0.95rem', lineHeight: '1.6', margin: 0 }}>
            Képviseld a csapatodat a Heti Párbajokban! A szerzett pontjaiddal a klubodat is a ranglista élére repítheted. Részt vehetsz a klubéletben. Látod a híreket, küldhetsz be házi feladatokat, vagy részt vehetsz a belső pályázatokon. A belépést a klub vezetői hagyják jóvá.
          </p>
        </div>
