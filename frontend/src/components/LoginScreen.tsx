...
export default function LoginScreen({ onLoginSuccess }: LoginScreenProps) {
  ...
  return (
    <div style={{
      ...
      position: 'relative', 
      backgroundColor: '#0f172a', // Sima sötét háttér a villámgyors renderelésért
        ...
        <div style={{ flex: '1 1 350px', maxWidth: '420px', width: '100%' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', width: '100%' }}>
              <div style={{ padding: '4px', background: 'rgba(255,255,255,0.02)', borderRadius: '50px', border: '1px solid rgba(255,255,255,0.06)', width: '100%', display: 'flex', justifyContent: 'center' }}>
                <GoogleLogin 
