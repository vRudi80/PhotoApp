...
tilePodcastDesc: 'Hallgass bennünket aktuális fotós témákról',
  ...
  "archivePosterHeader": "Kihívás EREDMÉNYEK",
  "archivePosterPlace": "HELY",
  "archivePosterFooterJoin": "Csatlakozz a kihívásokhoz:",
...
"helpFairScoreExample": "Példa: Az 'A' kép 22 csillagot kap 7 nézettségből, de a tulajdonos egyet sem szavaz le. A 'B' kép 11 csillagot kap 7 nézettségből, és hibátlanul szavaz. A 'B' kép megelőzi az 'A'-t, mert a mulasztó fotós pontjait felemészti a hatványozott büntetés!",
  ...
  "adminConfirmApprovePlan": "Biztosan ELFOGADOD és harcrendbe állítod ezt a beküldött haditervet?",
  "adminConfirmRejectPlan": "Biztosan ELUTASÍTOD ezt a beküldött haditervet?",
  ...
  "adminCoverLabel": "Kihívás Vizuális Borítóképe (Automata tömörítéssel)",
  "adminPreviewNew": "Új borítókép előnézet (Mentésre vár):",
  "adminPreviewCurrent": "Jelenleg aktív borítókép:",
  "adminDateStart": "Kihívás Kezdete (Óra/Perc is)",
  "adminDateEnd": "Kihívás Vége (Óra/Perc is)",
  ...
  mapNotSpecified: 'Nincs megadva',
    ...
    arenaAlbumHistoryTitle: 'Részvételi Történet ({count} csata)',
    ...
    planSubmitBtn: 'Terv beküldése bírálatra ⚔️',
    ...
    loginMainDesc: 'Lépj be az oldalra fdezz fel új helyszíneket, versengj a kihívásokban, kövesd a nemzetközi FIAP/MAFOSZ sikereidet és kérj profi AI képelemzést a portfóliódra.',
    ...
    viewBackBtn: 'Vissza a kihívásokhoz',
