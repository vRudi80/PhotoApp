...
const translations = {
  hu: {
    ...
    // 📸 HETI KÉPÉRTÉKELŐ (WEEKLY REVIEW) KULCSOK
    reviewTitle: 'Heti Képértékelő',
    reviewSelectRound: 'Forduló kiválasztása:',
    reviewArchiveBadge: 'Archívum (Lezárult)',
    reviewClosedBadge: 'Lezárult (Eredmények megtekintése)',
    reviewBtnHelp: 'Súgó & Szabályzat',
    reviewBtnCourses: 'Tanfolyamok',
    reviewBtnUpload: 'Kép Feltöltése',
    reviewBtnUploadLimit: 'Limit elérve',
    reviewScopeMy: 'Saját fotóim',
    reviewScopeAll: 'Összes fotó',
    reviewPendingCount: 'Értékelésre várók ({count})',
    reviewCategoriesLabel: 'Kategóriák:',
    reviewCatAll: 'Összes',
    reviewCatPortrait: 'Portré',
    reviewCatColor: 'Színes',
    reviewCatMonochrome: 'Monokróm',
    reviewCatNature: 'Természet',
    reviewSortLabel: 'Sorrend:',
    reviewSortMembers: 'Tagok értékelése',
    reviewSortMasters: 'Mesterek értékelése',
    reviewSortAi: 'AI értékelése',
    reviewRankMembers: 'Klubtagok',
    reviewRankMasters: 'Mesterek',
    reviewRankAi: 'AI FIAP',
    reviewStatusVoted: '✓ Már értékelted ({score} pont)',
    reviewStatusOwn: 'Saját fotó (Nem értékelheted)',
    reviewStatusClosed: 'Értékelés lezárult',
    reviewEmptyPending: 'Minden képet értékeltél ebben a fordulóban!',
    reviewEmptyMy: 'Még nem töltöttél fel képet ebben a fordulóban.',
    reviewEmptyFilter: 'Még nincsenek feltöltött képek a megadott szűrési feltételekkel.',

    // 💡 SÚGÓ MODÁL KULCSOK
    reviewHelpTitle: 'Heti Képértékelő – Útmutató & Szabályzat',
    reviewHelpWhatTitle: 'Mi ez a funkció?',
    reviewHelpWhatDesc: 'A Heti Képértékelő a fotóklubod automatizált szakmai műhelye. Lehetővé teszi, hogy a klubtagok hetente megosszák legfrissebb képeiket, és 3 független szemszögből kaphassanak objektív visszacsatolást a fejlődésükhöz.',
    reviewHelpScheduleTitle: 'Heti Ritmus & Határidők',
    reviewHelpSchedule1: 'Képfeltöltési időszak: Hétfő 00:00 – Vasárnap 24:00.',
    reviewHelpSchedule2: 'Értékelési időszak: Hétfő 00:00 – Szerda 24:00.',
    reviewHelpSchedule3: 'Eredményhirdetés & Zárás: Csütörtök 00:00-tól a képek archiválódnak, megjelennek az eredmények és a sorrendek.',
    reviewHelpGroupsTitle: 'A 3 Értékelő Csoport & Pontozás',
    reviewHelpGroup1Title: '1. Klubtagok (0 – 2 pont)',
    reviewHelpGroup1Desc: 'Minden klubtag tetszőleges számú képet értékelhet a sajátján kívül (0 = Elfogadható, 1 = Jó, 2 = Kiváló).',
    reviewHelpGroup2Title: '2. Mesterek (1 – 10 pont)',
    reviewHelpGroup2Desc: 'A Mesterek a klubvezető által megbízott tapasztalt fotósok és szakmai mentorok, akik 1-től 10-ig terjedő skálán adják meg a szakmai pontszámot.',
    reviewHelpGroup3Title: '3. AI Értékelő (Gemini 2.5) (10 – 100 pont)',
    reviewHelpGroup3Desc: 'A mesterséges intelligencia a nemzetközi FIAP photowork szempontrendszer alapján elemzi a képet. Besorolja kategóriába (portré, színes, monokróm, természet), szöveges kritikát ír, és hiányosság esetén ajánlja a klub megfelelő tanfolyamát.',
    reviewHelpRankTitle: 'Mit jelent a helyezés (pl. 12/321)?',
    reviewHelpRankDesc: 'A forduló lezárulta után a fotókártyán lévő tört számok azt mutatják meg, hogy az adott héten beküldött összes képből (pl. 321 fotóból) a fotód hányadik helyet érte el az adott csoport rangsorában:',
    ...
    archiveCountVotes: "Szavazat",
    archiveBtnBack: "Vissza az archívumhoz",
    archiveBtnDownloadPoster: "FB Plakát Letöltése (1200x1200px)",
    archiveBtnGeneratingPoster: "Plakát generálása...",
    archiveTabWinners: "GYŐZTESEK",
    archiveTabDetails: "RÉSZLETEK",
    archiveTabPrizes: "NYEREMÉNYEK",
    archiveTabRank: "RANGSOR",
    archiveWinnerTitleCard: "TOP PHOTOGRAPHER WINNER",
    archiveNoWinnerData: "Nincs kiértékelhető győztes adat.",
    archiveUnknownMaster: "Ismeretlen Képmester",
    archiveMetaSubmitted: "BEKÜLDÖTT",
    archiveMetaEnded: "VÉGZŐDÖTT",
    archivePrizesTitle: "Dobogós Nyeremények & Extra Cserék",
    archivePrizesDesc: "A futamok lezárulásakor a mezőny legkiemelkedőbb fotóművészei értékes globális Joker cseréket és exkluzív hozzáférést kapnak jutalmul:",
    archiveRank1st: "🥇 1. Helyezett (Győztes):",
    archiveRank1stReward: "+3 db globális Joker csere + 1 HÉTTEL MEGHOSSZABBÍTOTT PRÉMIUM TAGSÁG teljesen ingyen!",
    archiveRank2nd: "🥈 2. Helyezett:",
    archiveRank2ndReward: "+2 db Joker csere",
    archiveRank3rd: "🥉 3. Helyezett:",
    archiveRank3rdReward: "+1 db Joker csere",
    archiveSubTabTopPhoto: "TOP PHOTO",
    archiveSubTabMasterPick: "KÉPMESTER KIEMELÉS",
    archiveHighlightedByMaster: "Kiemelte a Képmester",
    archiveImgNotAvailable: "Kép nem elérhető",
    archivePosterHeader: "Játék EREDMÉNYEK",
    archivePosterPlace: "HELY",
    archivePosterFooterJoin: "Csatlakozz a játékokhoz:",
    rankComposer: "Komponista 📐",
    rankHunter: "Képvadász 📷",
    rankObserver: "Megfigyelő 👁️",
    rankScout: "Fényleső 🌱",
    rankWriter: "Fényíró 🎞️",
    rankAesthete: "Esztéta 💎",
    rankExpert: "Szakértő 🎯",
    rankMaster: "Képmester 🎨",
    rankGrandmaster: "Nagymester 🌟",
    roomPreviewLabel: "Új fotó feltöltése",

    roomJoinChallenge: "Nevezz a játékra!",
    ...
    adminTitle: "Játék kezelő központ",
    adminSubtitle: "A rendszer automatikusan indítja el az elfogadott játékokat, amint elérkezik a kezdő dátumuk!",
    ...
    adminConfirmApprovePlan: "Biztosan ELFOGADOD ezt a beküldött tervet?",
    adminConfirmRejectPlan: "Biztosan ELUTASÍTOD ezt a beküldött tervet?",
    adminDecisionSaved: "A döntés sikeresen rögzítve a naptárban!",
    adminFormNew: "Új Játék Kiírása",
    adminFormEdit: "Játék Szerkesztése",
    adminMasterAssign: "Kijelölt Képmester (Extra pontokat osztó főbíró)",
    adminMasterNone: "Nincs külön képmester kijelölve (Opcionális)",
    adminCoverLabel: "Játék Vizuális Borítóképe (Automata tömörítéssel)",
    adminPreviewNew: "Új borítókép előnézet (Mentésre vár):",
    adminPreviewCurrent: "Jelenleg aktív borítókép:",
    adminDateStart: "Játék Kezdete (Óra/Perc is)",
    adminDateEnd: "Játék Vége (Óra/Perc is)",
    adminBtnUpdate: "Változtatások Mentése és Élesítés",
    adminBtnSave: "Játék Mentése",
    adminGanttTitle: "Játék Tervek & Gantt Idővonal",
    adminStatusPending: "BÍRÁLATRA VÁR",
    adminStatusRejected: "ELUTASÍTOD",
    adminStatusEnded: "LEZÁRULT",
    adminStatusScheduled: "BEÜTEMEZETT",
    adminStatusLive: "ÉLŐ FUTAM",
    ...
    adminGanttChallengeColumn: "Játék terv",
    ...
    roomShutterIso: "Záridő / ISO:",
    roomSoftware: "Szoftver:",
    roomExifShieldTitle: "EXIF Diagnosztika és AI Elleni Védelem aktív",
    ...
    roomLegacyPhoto: "Exif hiányzik: korábban feltöltött kép",
    roomAiSuspect: "AI GYANÚ: Hiányzó hardveres pecsét!",
    ...
    mapDashThankYou: 'NAGYON KÖSZÖNJÜK!',
    ...
    ticketsNewTicketTitle: 'Új Segítségkérés indítása',
    ...
    arenaAlbumEmptyDesc: 'Nevezz be a futó játékok egyikébe, és a fotóid automatikusan bekerülnek ide!',
    arenaAlbumTitle: 'Képcsarnokod',
    arenaAlbumSubtitle: 'Az összes képed eredménye, elért sikerei és történelme egyetlen helyen.',
    arenaAlbumInBattle: 'Harcban',
    ...
    arenaAlbumHistoryTitle: 'Részvételi Történet ({count} játék)',
    ...
    profClubTitle: 'Fotóklub tagság beállítása',
    ...
    profClubNone: 'Jelenleg nem tartozol egyetlen klubhoz sem. Válassz az alábbi, aktív vezetőséggel rendelkező klubok közül! Amennyiben nem találod a klubod/csapatod - de tag vagy valahol -, akkor még nincs vezetője az alkalmazásban. Kérlek vedd fel a kapcsolatot az adminnal a "Support & Segítség" részen ',
    profSelectClub: '-- Válassz fotóklubot --',
    profSendRequest: 'Csatlakozási kérelem elküldése',
    ...
    msgRequestSent: 'Kérelem elküldve a vezetőségnek!',
    ...
    helpJokerDesc: 'Úgy érzed, jobb fotót is tudnál mutatni az adott témában? Minden Játékban ugyanazzal a Joker ponttal szabadon cserélgetheted a képeidet az Aréna Képtáradból vagy a galériádból! Az új fotód 0 pontról indul, de a régit bármikor büntetés nélkül visszahozhatod.',
    helpMasterTitle: 'Ki az a Témavezető Képmester?',
    helpMasterDesc: 'Minden Játéknak van egy kijelölt Képmestere, aki a forduló szakmai házigazdája. Mivel ő felügyeli a válogatást, saját alkotással nem indulhat az adott futamban. Cserébe kap plusz 2 nap Prémium előfizetést és exkluzív Mester-szavazatokat, amelyek egyenként fixen +10 pontot érnek, így kiemelt szerepe van a legszebb képek felemelésében!',
    ...
    roomVotingArena: 'Értékelő Aréna',
    ...
    roomOffTopicWarning: ' {count} játékos szerint ez a kép Off-Topic vagy AI generált!',
    ...
    roomVotePass: 'Nem tetszik (0 pont)',
    roomReportBtn: 'Off-Topic/AI gyanús Jelentés',
    ...
    roomYouAreMasterDesc: 'Ebben a futamban te lettél felkérve a képmesternek! Saját alkotással nem nevezhetsz, cserébe kapsz egyenként +10 pontot érő mesterszavazatot, amit a szavazás során oszthatsz szét a kedvenc képeid között.',
    roomResult: 'Eredmény',
    roomViews: 'Szavaztak',
    ...
    roomSwapGalleryBtn: 'Joker Csere az Aréna Képtárból',
    roomNoSwapsLeft: 'Elfogytak a globális Joker cseréid! Vásárolj cserét pontokért.',
    roomPastEntriesTitle: 'Korábbi fotóid ebben a fordulóban',
    roomPastSavedScore: 'Eltárolt korábbi állás:',
    roomReactivateBtn: 'Visszaaktiválás',
    ...
    roomChooseGalleryUploadBtn: 'Választás az Aréna Képtárból',
    roomClubLeague: 'Klubok Ligája',
    roomLiveBadge: 'ÉLŐ',
    ...
    roomBlindLeaderboard: 'Rejtett Toplista',
    ...
    planTitle: 'Új Játék Javaslata',
    planDesc: 'Vázold fel a Játékt! Jóváhagyás után, a javaslatod bekerül a hivatalos közelgő Játékok közé.',
    planLabelTitle: 'Játék megnevezése (Téma) *',
    ...
    planSubmitting: 'Terv küldése...',
    planSubmitBtn: 'Terv beküldése bírálatra',
    msgFillAllFields: 'Minden kötelező mezőt tölts ki!',
    msgProposalSuccess: 'Terv sikeresen benyújtva bírálatra!',
    ...
    archiveTitle: 'Befejezett Játékok',
    ...
    archiveClubLeague: 'Klubok Ligája Eredmény',
    ...
    trophyNoPastEntries: 'Még nincs befejezett Játékod!',
    trophyNoPastEntriesDesc: 'Vegyél részt a Játékokban, és itt fognak megjelennen a korábbi eredményeid.',
    ...
    modalUploadTitle: 'Nevezés az Aréna Képtáradból',
    ...
    modalBadgeSwapBack: 'Visszacsere',
    ...
    shareImageError: 'Kép betöltési hiba',
    sharePhotographer: 'Fotóművész',
    shareRankSuffix: '. HELYEZÉS',
    shareTopicLabel: 'Játék témája:',
    shareCommunityRating: 'Közösségi Értékelés',
    shareTotalEntriesLabel: 'Összes Nevező',
    sharePhotosCount: ' fotó',
    sharePlayNext: 'Játssz Te is következő Játékban:',
    shareSavingTrophy: 'Trófea mentése...',
    shareSaveBtn: 'Kártya Megosztása / Mentése',

    loginBadge: 'Vártunk már!',
    loginTitlePre: 'PhotAwesome.com ',
    loginTitleGradient: 'A fotósok digitális otthona',
    loginMainDesc: 'Lépj be az oldalra fdezz fel új helyszíneket, versengj a Játékokban, kövesd a nemzetközi FIAP/MAFOSZ sikereidet és kérj profi AI képelemzést a portfóliódra.',
    ...
    loginPhotoHistoryTitle: 'Fotótörténeti Album',
    loginPhotoHistoryDesc: 'Ikonikus fotük a történelemből. Híres fotósok és érdekes információk.',
    ...
    packBasicF3: 'FIAP/MAFOSZ Statisztikák, szintek, szalonok',
    ...
    mapJumpLabel: 'Ugrás településre / címre',
    mapJumpPlaceholder: 'Város, utca (pl. Budapest)',
    mapJumpBtn: 'Ugrás',
    mapCloseResults: '✖ Bezárás',
    mapFormEditTitle: '"{title}" szerkesztése',
    ...
    mapFormTimeLabel: 'Készítés napszakja',
    ...
    mapBtnRoadmap: 'Utcatérkép',
    mapBtnHybrid: 'Műholdas Hibrid',
    ...
    viewNoActiveLeaguesDesc: 'Pihenj meg, hamarosan új Játék érkezik.',
    viewLobbyTitle: 'Chat',
    ...
    viewBackBtn: 'Vissza a Játékokhoz',
    viewPreparingRoom: 'Játékszoba előkészítése...',
    ...
    msgSwapConfirm: 'Biztosan elhasználsz 1 Joker cserét? Az új képed 0 pontról fog indulni, de a korábbi képedet bármikor visszahozhatod!',
    msgSwapSuccess: 'Kép sikeresen lecserélve! Újra indul a harc!',
    msgSwapErrorMain: 'Hiba a csere során!',
    msgSwapBackConfirm: 'Biztosan visszatérsz ehhez a korábbi pályaművedhez? Ez 1 Joker pontodba fog kerülni, viszont visszakapod az akkori csillagaidat!',
    msgSwapBackSuccess: 'Sikeresen visszaaktiváltad a korábbi fotódat!',
    msgSwapExistingConfirm: 'Biztosan elhasználsz 1 Joker cserére erre az albumképre? Ez a fotó most 0 pontról fog újrainduini ebben a fordulóban!',
    ...
    contAdminCreateTitle: 'Globális Pályázat Kiírása (Admin)',
    ...
    contLabelStart: 'Pályázat Kezdete',
    ...
    contCatsSettingsTitle: 'Kategória Ponthatárok & Díjak',
    ...
    contTabClubTitle: 'Klubom Aktív Pályázatai',
    ...
    contCancel: 'Mégse',
    contPayBannerTitle: 'Nevezési díj kiegyenlítése szükséges',
    ...
    juryManageTitle: 'Bírálóbizottság Összeállítása',
    ...
    contFormEditSettingsTitle: 'Kategória Ponthatárok & Díjak (Módosítás)',
    contSaveChange: 'Változtatások mentése',
    judgingConsoleTitle: 'Értékelő Pult: ',
    ...
    planLabelTitleEn: '🇬🇧 Játék címe (Angolul - Opcionális)',
    ...
    adminLabelTitleEn: '🇬🇧 Játék témája angolul (Opcionális)',
    adminPlaceholderTitleEn: 'E.g., Spring Lights',
    adminLabelDescEn: '🇬🇧 Leírás angolul (Opcionális)',
    adminPlaceholderDescEn: 'Guideline and rules for photographers in English...',

    upTitle: 'Közelgő Játékok Menetrendje',
    upDesc: 'Már jóváhagyott, hamarosan élesedő játékok. Jelentkezz Képmesternek!',
    upClosePlanner: '✕ Tervező bezárása',
    upOpenPlanner: 'Új játékterv benyújtása',
    upEmpty: 'Nincs betárazva elkövetkező játék. Kattints a fenti gombra, és javasolj egy új témát!',
    upDaily: '🔴 Villámfutam',
    ...
    msgApplyConfirm: 'Biztosan jelentkezel ennek a futamnak a Képmesterének?\n\nFigyelem: Képmesterként saját fotóval nem indulhatsz a futamban, viszont kapsz exkluzív +10 pontot érő szavazatot!',
    msgApplySuccess: 'Jelentkezésed sikeresen elküldve! A főadmin hamarosan elbírálja a műszerfalon.',

    // Album és Portfólió kulcsok
    albumTitle: 'Saját Képalbum (Portfólió)',
    ...
    albumStorageWarning: 'A portfólió tárhelyed majdnem betelt!',
    ...
    msgAlbumLegacyDownloadError: 'Ez egy korábbi rendszerből származó fotó, a letöltés nem lehetséges.',
    msgAlbumTitleRequired: 'A cím nem lehet üres!',
    msgAlbumStorageFullUpgrade: 'Megtelt a tárhelyed! Válts nagyobb csomagra.',
    ...
    msgAlbumStorageFull: 'Megtelt a tárhelyed ({size})!',
  ...
  en: {
    ...
    // 📸 WEEKLY REVIEW KEYS (ANGOL)
    reviewTitle: 'Weekly Photo Review',
    reviewSelectRound: 'Select round:',
    reviewArchiveBadge: 'Archive (Closed)',
    reviewClosedBadge: 'Closed (View results)',
    reviewBtnHelp: 'Help & Rules',
    reviewBtnCourses: 'Courses',
    reviewBtnUpload: 'Upload Photo',
    reviewBtnUploadLimit: 'Limit reached',
    reviewScopeMy: 'My Photos',
    reviewScopeAll: 'All Photos',
    reviewPendingCount: 'Pending reviews ({count})',
    reviewCategoriesLabel: 'Categories:',
    reviewCatAll: 'All',
    reviewCatPortrait: 'Portrait',
    reviewCatColor: 'Color',
    reviewCatMonochrome: 'Monochrome',
    reviewCatNature: 'Nature',
    reviewSortLabel: 'Sort by:',
    reviewSortMembers: 'Members\' Rating',
    reviewSortMasters: 'Masters\' Rating',
    reviewSortAi: 'AI Rating',
    reviewRankMembers: 'Club Members',
    reviewRankMasters: 'Masters',
    reviewRankAi: 'AI FIAP',
    reviewStatusVoted: '✓ Already rated ({score} pts)',
    reviewStatusOwn: 'Own photo (Cannot rate)',
    reviewStatusClosed: 'Evaluation closed',
    reviewEmptyPending: 'You have rated all photos in this round!',
    reviewEmptyMy: 'You haven\'t uploaded any photos in this round yet.',
    reviewEmptyFilter: 'No photos uploaded matching the filter criteria yet.',

    // 💡 HELP MODAL KEYS (ANGOL)
    reviewHelpTitle: 'Weekly Photo Review – Guide & Rules',
    reviewHelpWhatTitle: 'What is this feature?',
    reviewHelpWhatDesc: 'The Weekly Photo Review is your photo club\'s automated workshop. It allows members to share their latest photos weekly and receive objective feedback from 3 independent perspectives.',
    reviewHelpScheduleTitle: 'Weekly Rhythm & Deadlines',
    reviewHelpSchedule1: 'Photo upload period: Monday 00:00 – Sunday 24:00.',
    reviewHelpSchedule2: 'Evaluation period: Monday 00:00 – Wednesday 24:00.',
    reviewHelpSchedule3: 'Results & Closing: From Thursday 00:00, photos are archived, and results/rankings are revealed.',
    reviewHelpGroupsTitle: 'The 3 Evaluator Groups & Scoring',
    reviewHelpGroup1Title: '1. Club Members (0 – 2 points)',
    reviewHelpGroup1Desc: 'All members can rate any photos except their own (0 = Acceptable, 1 = Good, 2 = Excellent).',
    reviewHelpGroup2Title: '2. Masters (1 – 10 points)',
    reviewHelpGroup2Desc: 'Masters are experienced photographers and mentors appointed by the club leader, scoring from 1 to 10.',
    reviewHelpGroup3Title: '3. AI Evaluator (Gemini 2.5) (10 – 100 points)',
    reviewHelpGroup3Desc: 'AI analyzes the image based on international FIAP standards, categorizes it, writes feedback, and suggests club courses for improvement.',
    reviewHelpRankTitle: 'What does the rank mean (e.g., 12/321)?',
    reviewHelpRankDesc: 'After the round closes, the fraction on the card indicates your photo\'s rank out of the total submissions (e.g., out of 321 photos) for each group:',
    ...
    roomZoomLabel: "ZOOM",
    roomShutterIso: "Shutter / ISO:",
    roomSoftware: "Software:",
    roomExifShieldTitle: "EXIF Diagnostics & AI Protection active",
    ...
    archiveCountVotes: "Votes",
    archiveBtnBack: "Back to Archive",
    archiveBtnDownloadPoster: "🏆 Download FB Poster (1200x1200px)",
    archiveBtnGeneratingPoster: "⏳ Generating Poster...",
    archiveTabWinners: "WINNERS",
    archiveTabDetails: "DETAILS",
    archiveTabPrizes: "PRIZES",
    archiveTabRank: "RANK",
    archiveWinnerTitleCard: "TOP PHOTOGRAPHER WINNER",
    archiveNoWinnerData: "No winner data available.",
    archiveUnknownMaster: "Unknown Master",
    archiveMetaSubmitted: "SUBMITTED",
    archiveMetaEnded: "ENDED",
    archivePrizesTitle: "🏆 Podium Rewards & Extra Swaps",
    archivePrizesDesc: "At the end of each challenge, the most outstanding photographers receive global Joker swaps and exclusive premium access:",
    archiveRank1st: "🥇 1st Place (Winner):",
    archiveRank1stReward: "+3 global Joker Swaps + 1 WEEK EXTENDED PREMIUM MEMBERSHIP completely free!",
    archiveRank2nd: "🥈 2nd Place:",
    archiveRank2ndReward: "+2 Joker Swaps",
    archiveRank3rd: "🥉 3rd Place:",
    archiveRank3rdReward: "+1 Joker Swap",
    archiveSubTabTopPhoto: "TOP PHOTO",
    archiveSubTabMasterPick: "CHALLENGE MASTER PICKS",
    archiveHighlightedByMaster: "Highlighted by Master",
    archiveImgNotAvailable: "Image not found",
    archivePosterHeader: "Challenge RESULTS",
    archivePosterPlace: "PLACE",
    archivePosterFooterJoin: "Join the Arena Battle:",
    rankComposer: "Composer 📐",
    rankHunter: "Photo Hunter 📷",
    rankObserver: "Observer 👁️",
    rankScout: "Light Scout 🌱",
    rankWriter: "Light Writer 🎞️",
    rankAesthete: "Aesthete 💎",
    rankExpert: "Expert 🎯",
    ...
    profClubTitle: 'Photo Club Membership Settings',
    ...
    profClubNone: 'You currently do not belong to any club. Choose from the active clubs below! If you cannot find your club/group, please contact with the admin in the Support menu',
    ...
    helpMasterDesc: 'Every challenge has a designated Challenge Master, who serves as the professional host of the round. Since they oversee the selection, they cannot participate with their own work in that specific match. In return, they receive 2 extra days premium subscription and exclusive Master votes, each worth a fixed +10 points, playing a key role in elevating the most beautiful images!',
    ...
    roomYouAreMasterDesc: 'You have been appointed Challenge Master for this match! You cannot compete with your own work, but you receive exclusive Mastervotes worth +10 points each to distribute among your favorite pictures.',
    roomResult: 'Score',
    roomViews: 'Views',
    ...
    roomSwapGalleryBtn: 'Joker Swap from Arena Gallery',
    roomNoSwapsLeft: '🔒 Out of global Joker swaps! Buy swap for points.',
    ...
    loginPhotoHistoryTitle: 'Photohistory album',
    loginPhotoHistoryDesc: 'Iconic photos from the history. Stories, famous photographers.',
    ...
    packBasicF3: 'FIAP/MAFOSZ Statistics, ranks, salons',
    packBasicF4: 'FIAP excel export',
    packBasicF5: '3 photos can be uploaded in the club weekly review',
    packBasicF6: 'Photohistory gallery',
    packBasicF7: '3D online exhibition',
    ...
    msgApplyConfirm: '⚔️ Are you sure you want to apply as the Master for this match?\n\nAttention: As a Master, you cannot enter the match with your own photo, but you will receive exclusive votes worth +10 points each!',
