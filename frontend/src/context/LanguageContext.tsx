...
"helpFairScoreExample": "Példa: Az 'A' kép 22 csillagot kap 7 nézettségből, de a tulajdonos egyet sem szavaz le. A 'B' kép 11 csillagot kap 7 nézettségből, és hibátlanul szavaz. A 'B' kép megelőzi az 'A'-t, mert a mulasztó fotós pontjait felemészti a hatványozott büntetés!",
  ...
  mapNotSpecified: 'Nincs megadva',
    ...
    profClubNone: 'Jelenleg nem tartozol egyetlen klubhoz sem. Válassz az alábbi, aktív vezetőséggel rendelkező klubok közül! Amennyiben nem találod a klubod, akkor még nincs vezetője az alkalmazásban. Kérlek bedd fel a kapcsolatot az adminnal a "Support & Segítség" részen ',
