...
module.exports = function(app, pool, drive, upload, cleanupTempFile) {
  ...
  // ====================================================================
  // 2. Új helyszín felvitele (VÉDETT - INTEGRÁLT JUTALOMPONT MOTORRAL)
  // ====================================================================
  ...
  // ====================================================================
  // 3. Helyszín szerkesztése és mozgatása (VÉDETT)
  // ====================================================================
